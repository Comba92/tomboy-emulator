...
static NEW_LICESEE_MAP: LazyLock<HashMap<&str, &'static str>> = LazyLock::new(|| {
    HashMap::from([
        ("00", "None"),
...
static CART_TYPE_MAP: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    HashMap::from([
        (0x00,	"ROM ONLY"),
        (0x01,	"MBC1"),
        (0x02,	"MBC1+RAM"),
...
static ROM_SIZE_MAP: LazyLock<HashMap<u8, usize>> = LazyLock::new(|| {
    HashMap::from([
        (0x00, 2),
        (0x01, 4),
        (0x02, 8),
...
static RAM_SIZE_MAP: LazyLock<HashMap<u8, usize>> = LazyLock::new(|| {
    HashMap::from([
        (0x00, 0),
        (0x01, 0),
        (0x02, 1),
...
static LICENSEE_MAP: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    HashMap::from([
        (0x00,	"None"),
        (0x01,	"Nintendo"),
        (0x08,	"Capcom"),
